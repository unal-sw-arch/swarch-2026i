            ...
            tabContent
                ...
                .navigationDestination(for: GameDestination.self) { destination in
                    ...
                    case .storePrice(let game):
                        GameDetailView(game: game, onClose: popNavigation)
                    case .gameName(let name):
                        GameDetailView(gameName: name, onClose: popNavigation)
                    case .rankedGame(let ranked):
                        GameDetailView(rankedGame: ranked, onClose: popNavigation)
                    case .ranking:
