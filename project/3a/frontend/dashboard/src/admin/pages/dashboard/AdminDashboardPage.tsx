// Original (pre-ManagerDashboard) dashboard, preserved verbatim except for the
// renamed export. The current DashboardPage was rewired to real restaurant data
// for RESTAURANT_MANAGER; this mock-data version is kept so it can later be
// wired as the ADMIN landing page (global/platform metrics). Not routed yet.
